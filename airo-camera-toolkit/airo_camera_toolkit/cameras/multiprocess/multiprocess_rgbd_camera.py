...
class MultiprocessRGBDReceiver(CameraMixin, RGBMixin, DepthMixin, PointCloudMixin, SharedMemoryReceiver):
    """Multiprocess implementation of RGBDCamera. To be used with MultiprocessRGBDCameraPublisher."""
