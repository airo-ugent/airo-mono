...
#     def handle(self):
#         print("accept the request from RobotControlBox")
#         while True:
#             try:
#                 self.data = self.request.recv(1024).strip()
#             except ConnectionResetError as e:
#                 print('turn off the TCP remote connection')
#                 break
#             # print(self.data)
...
class SchunkGripper:
    ...
    def __init__(self, local_ip="10.42.0.1", local_port=46995):
        ...
        # self.server = socketserver.ThreadingTCPServer((host, port), TCPHandler)
    ...
    def recv_schunk(self):
        ...
        #     # print('recieve data')
        #     time.sleep(0.1)
        #     self.recv_data = client.recv(1024)
    ...
    def schunk_rpcCallRe(self, socket_name, command):
        ...
        # # ------------------------
        # self.execute_command(f'response=socket_read_line("{socket_name}", {self.timeout})\n')
        # # response = self.schunk_socket.recv(1024)
        # self.execute_command(f'socket_send_line(response, "{self.schunk_socket_name}")')
        # self.schunk_recv_data = self.schunk_client.recv(1024)
        # self.execute_command(f'socket_close("{socket_name}")')
        # return self.schunk_recv_data
